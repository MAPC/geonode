...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.website_url'
        db.add_column('maps_contact', 'website_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Contact.mapc_newsletter'
        db.add_column('maps_contact', 'mapc_newsletter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Contact.mbdc_newsletter'
        db.add_column('maps_contact', 'mbdc_newsletter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.website_url'
        db.delete_column('maps_contact', 'website_url')

        # Deleting field 'Contact.mapc_newsletter'
        db.delete_column('maps_contact', 'mapc_newsletter')

        # Deleting field 'Contact.mbdc_newsletter'
        db.delete_column('maps_contact', 'mbdc_newsletter')
    ...
    models = {
        ...
        'maps.contact': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mapc_newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mbdc_newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
