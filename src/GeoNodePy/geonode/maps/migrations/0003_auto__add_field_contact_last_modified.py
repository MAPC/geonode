...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maps_contact', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 1, 21), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.last_modified'
        db.delete_column('maps_contact', 'last_modified')
