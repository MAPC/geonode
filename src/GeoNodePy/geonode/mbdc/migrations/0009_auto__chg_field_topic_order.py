...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topic.order'
        db.alter_column('mbdc_topic', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Topic.order'
        db.alter_column('mbdc_topic', 'order', self.gf('django.db.models.fields.IntegerField')(default=0))
