...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.content_markup_type'
        db.add_column('mbdc_hero', 'content_markup_type', self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30, blank=True), keep_default=False)

        # Adding field 'Hero._content_rendered'
        db.add_column('mbdc_hero', '_content_rendered', self.gf('django.db.models.fields.TextField')(default='content'), keep_default=False)

        # Changing field 'Hero.content'
        db.alter_column('mbdc_hero', 'content', self.gf('markupfield.fields.MarkupField')(null=True, rendered_field=True))


    def backwards(self, orm):
        
        # Deleting field 'Hero.content_markup_type'
        db.delete_column('mbdc_hero', 'content_markup_type')

        # Deleting field 'Hero._content_rendered'
        db.delete_column('mbdc_hero', '_content_rendered')

        # User chose to not deal with backwards NULL issues for 'Hero.content'
        raise RuntimeError("Cannot reverse this migration. 'Hero.content' and its values cannot be restored.")
