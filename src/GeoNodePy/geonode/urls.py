...
urlpatterns = patterns('',
    ...
    (r'^snapshots/', include('geonode.snapshots.urls')),
    (r'^pages/', include('geonode.mbdc.urls')),
    url(r'^explore/regional-map-gallery/$', 'geonode.mbdc.views.calendar', name='mbdc-regional-map-gallery'),
    url(r'^explore/regional-map-gallery/(?P<topic_slug>[-\w]+)/$', 'geonode.mbdc.views.calendar', name='mbdc-regional-map-gallery-topic'),
    url(r'^explore/gallery/$', 'geonode.mbdc.views.gallery', name='mbdc-gallery'),
