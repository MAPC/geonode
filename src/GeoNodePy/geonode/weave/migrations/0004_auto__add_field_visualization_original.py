...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visualization.original'
        db.add_column('weave_visualization', 'original', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weave.Visualization'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visualization.original'
        db.delete_column('weave_visualization', 'original_id')
