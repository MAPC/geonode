...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visualization.year'
        db.add_column('weave_visualization', 'year', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Removing M2M table for field topic on 'Visualization'
        db.delete_table('weave_visualization_topic')
        ...
        # Changing field 'Visualization.last_modified'
        db.alter_column('weave_visualization', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))


    def backwards(self, orm):
        
        # Deleting field 'Visualization.year'
        db.delete_column('weave_visualization', 'year')

        # Adding M2M table for field topic on 'Visualization'
        db.create_table('weave_visualization_topic', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('visualization', models.ForeignKey(orm['weave.visualization'], null=False)),
            ('topic', models.ForeignKey(orm['mbdc.topic'], null=False))
        ))
        db.create_unique('weave_visualization_topic', ['visualization_id', 'topic_id'])
        ...
        # Changing field 'Visualization.last_modified'
        db.alter_column('weave_visualization', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
