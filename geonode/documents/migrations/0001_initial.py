...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('documents_contactrole', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name='document_contact', to=orm['people.Profile'])),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.Document'], null=True)),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(related_name='document_role', to=orm['people.Role'])),
        ))
        db.send_create_signal('documents', ['ContactRole'])

        # Adding unique constraint on 'ContactRole', fields ['contact', 'document', 'role']
        db.create_unique('documents_contactrole', ['contact_id', 'document_id', 'role_id'])
        ...
        db.create_table('documents_document', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['layers.TopicCategory'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'ContactRole', fields ['contact', 'document', 'role']
        db.delete_unique('documents_contactrole', ['contact_id', 'document_id', 'role_id'])

        # Deleting model 'ContactRole'
        db.delete_table('documents_contactrole')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 20, 27, 35, 286902)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 20, 27, 35, 290959)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 20, 27, 35, 290845)'}),
