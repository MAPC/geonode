...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.map'
        db.add_column('masshealth_datastories_page', 'map', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.Map'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.map'
        db.delete_column('masshealth_datastories_page', 'map_id')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 9, 44, 52, 154692)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 9, 44, 52, 153178)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 9, 44, 52, 153096)'}),
        ...
        'relationships.relationship': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'related_name': "'relationships'", 'to': "orm['sites.Site']"}),
